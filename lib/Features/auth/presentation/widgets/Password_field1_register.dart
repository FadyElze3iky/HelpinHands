...
class PasswordTextField1Resigter extends StatefulWidget {
  const PasswordTextField1Resigter(
...
class _PasswordTextFieldState extends State<PasswordTextField1Resigter> {
