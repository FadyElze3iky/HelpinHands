...
class NotificationUtils {
  ...
  ************************************************ */
  ...
  Future<void> showBasicNotification(
      int id, String contant1, String contant2) async {
    try {
  ...
  static Future<void> showNotificationWithTimeout(int id) async {
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: id,
        channelKey: 'basic_channel',
        title: 'Accident detect!!',
        body: 'click button if not accident',
        summary: 'Timeout in 10 seconds',
        // largeIcon: 'assets/icons/locationIcon.png',
